...
const (
	...
	NodeServiceName = "mineserver.v1.NodeService"
)
...
const (
	...
	NodeServiceListNodesProcedure = "/mineserver.v1.NodeService/ListNodes"
	// NodeServiceGetNodeProcedure is the fully-qualified name of the NodeService's GetNode RPC.
	NodeServiceGetNodeProcedure = "/mineserver.v1.NodeService/GetNode"
	// NodeServiceCreateNodeProcedure is the fully-qualified name of the NodeService's CreateNode RPC.
	NodeServiceCreateNodeProcedure = "/mineserver.v1.NodeService/CreateNode"
	// NodeServiceUpdateNodeProcedure is the fully-qualified name of the NodeService's UpdateNode RPC.
	NodeServiceUpdateNodeProcedure = "/mineserver.v1.NodeService/UpdateNode"
	// NodeServiceDeleteNodeProcedure is the fully-qualified name of the NodeService's DeleteNode RPC.
	NodeServiceDeleteNodeProcedure = "/mineserver.v1.NodeService/DeleteNode"
	// NodeServicePingNodeProcedure is the fully-qualified name of the NodeService's PingNode RPC.
	NodeServicePingNodeProcedure = "/mineserver.v1.NodeService/PingNode"
)

// NodeServiceClient is a client for the mineserver.v1.NodeService service.
...
// NewNodeServiceClient constructs a client for the mineserver.v1.NodeService service. By default,
...
func NewNodeServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NodeServiceClient {
	...
	nodeServiceMethods := v1.File_mineserver_v1_node_proto.Services().ByName("NodeService").Methods()
...
// ListNodes calls mineserver.v1.NodeService.ListNodes.
...
// GetNode calls mineserver.v1.NodeService.GetNode.
...
// CreateNode calls mineserver.v1.NodeService.CreateNode.
...
// UpdateNode calls mineserver.v1.NodeService.UpdateNode.
...
// DeleteNode calls mineserver.v1.NodeService.DeleteNode.
...
// PingNode calls mineserver.v1.NodeService.PingNode.
...
// NodeServiceHandler is an implementation of the mineserver.v1.NodeService service.
...
func NewNodeServiceHandler(svc NodeServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/mineserver.v1.NodeService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNodeServiceHandler) ListNodes(context.Context, *connect.Request[v1.ListNodesRequest]) (*connect.Response[v1.ListNodesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.NodeService.ListNodes is not implemented"))
}
...
func (UnimplementedNodeServiceHandler) GetNode(context.Context, *connect.Request[v1.GetNodeRequest]) (*connect.Response[v1.GetNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.NodeService.GetNode is not implemented"))
}
...
func (UnimplementedNodeServiceHandler) CreateNode(context.Context, *connect.Request[v1.CreateNodeRequest]) (*connect.Response[v1.CreateNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.NodeService.CreateNode is not implemented"))
}
...
func (UnimplementedNodeServiceHandler) UpdateNode(context.Context, *connect.Request[v1.UpdateNodeRequest]) (*connect.Response[v1.UpdateNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.NodeService.UpdateNode is not implemented"))
}
...
func (UnimplementedNodeServiceHandler) DeleteNode(context.Context, *connect.Request[v1.DeleteNodeRequest]) (*connect.Response[v1.DeleteNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.NodeService.DeleteNode is not implemented"))
}
...
func (UnimplementedNodeServiceHandler) PingNode(context.Context, *connect.Request[v1.PingNodeRequest]) (*connect.Response[v1.PingNodeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.NodeService.PingNode is not implemented"))
}
