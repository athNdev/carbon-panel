...
const (
	...
	ConfigServiceName = "mineserver.v1.ConfigService"
)
...
const (
	...
	// GetServerConfig RPC.
	ConfigServiceGetServerConfigProcedure = "/mineserver.v1.ConfigService/GetServerConfig"
	// ConfigServiceUpdateServerConfigProcedure is the fully-qualified name of the ConfigService's
	// UpdateServerConfig RPC.
	ConfigServiceUpdateServerConfigProcedure = "/mineserver.v1.ConfigService/UpdateServerConfig"
	// ConfigServiceGetGlobalSettingsProcedure is the fully-qualified name of the ConfigService's
	// GetGlobalSettings RPC.
	ConfigServiceGetGlobalSettingsProcedure = "/mineserver.v1.ConfigService/GetGlobalSettings"
	// ConfigServiceUpdateGlobalSettingsProcedure is the fully-qualified name of the ConfigService's
	// UpdateGlobalSettings RPC.
	ConfigServiceUpdateGlobalSettingsProcedure = "/mineserver.v1.ConfigService/UpdateGlobalSettings"
	...
	ConfigServiceSyncGlobalSettingsToServersProcedure = "/mineserver.v1.ConfigService/SyncGlobalSettingsToServers"
)

// ConfigServiceClient is a client for the mineserver.v1.ConfigService service.
...
// NewConfigServiceClient constructs a client for the mineserver.v1.ConfigService service. By
...
func NewConfigServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ConfigServiceClient {
	...
	configServiceMethods := v1.File_mineserver_v1_config_proto.Services().ByName("ConfigService").Methods()
...
// GetServerConfig calls mineserver.v1.ConfigService.GetServerConfig.
...
// UpdateServerConfig calls mineserver.v1.ConfigService.UpdateServerConfig.
...
// GetGlobalSettings calls mineserver.v1.ConfigService.GetGlobalSettings.
...
// UpdateGlobalSettings calls mineserver.v1.ConfigService.UpdateGlobalSettings.
...
// SyncGlobalSettingsToServers calls mineserver.v1.ConfigService.SyncGlobalSettingsToServers.
...
// ConfigServiceHandler is an implementation of the mineserver.v1.ConfigService service.
...
func NewConfigServiceHandler(svc ConfigServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/mineserver.v1.ConfigService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedConfigServiceHandler) GetServerConfig(context.Context, *connect.Request[v1.GetServerConfigRequest]) (*connect.Response[v1.GetServerConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.ConfigService.GetServerConfig is not implemented"))
}
...
func (UnimplementedConfigServiceHandler) UpdateServerConfig(context.Context, *connect.Request[v1.UpdateServerConfigRequest]) (*connect.Response[v1.UpdateServerConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.ConfigService.UpdateServerConfig is not implemented"))
}
...
func (UnimplementedConfigServiceHandler) GetGlobalSettings(context.Context, *connect.Request[v1.GetGlobalSettingsRequest]) (*connect.Response[v1.GetGlobalSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.ConfigService.GetGlobalSettings is not implemented"))
}
...
func (UnimplementedConfigServiceHandler) UpdateGlobalSettings(context.Context, *connect.Request[v1.UpdateGlobalSettingsRequest]) (*connect.Response[v1.UpdateGlobalSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.ConfigService.UpdateGlobalSettings is not implemented"))
}
...
func (UnimplementedConfigServiceHandler) SyncGlobalSettingsToServers(context.Context, *connect.Request[v1.SyncGlobalSettingsToServersRequest]) (*connect.Response[v1.SyncGlobalSettingsToServersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.ConfigService.SyncGlobalSettingsToServers is not implemented"))
}
