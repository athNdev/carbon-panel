...
const (
	...
	UserServiceName = "mineserver.v1.UserService"
)
...
const (
	...
	UserServiceListUsersProcedure = "/mineserver.v1.UserService/ListUsers"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/mineserver.v1.UserService/GetUser"
	// UserServiceCreateUserProcedure is the fully-qualified name of the UserService's CreateUser RPC.
	UserServiceCreateUserProcedure = "/mineserver.v1.UserService/CreateUser"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/mineserver.v1.UserService/UpdateUser"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/mineserver.v1.UserService/DeleteUser"
)

// UserServiceClient is a client for the mineserver.v1.UserService service.
...
// NewUserServiceClient constructs a client for the mineserver.v1.UserService service. By default,
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_mineserver_v1_user_proto.Services().ByName("UserService").Methods()
...
// ListUsers calls mineserver.v1.UserService.ListUsers.
...
// GetUser calls mineserver.v1.UserService.GetUser.
...
// CreateUser calls mineserver.v1.UserService.CreateUser.
...
// UpdateUser calls mineserver.v1.UserService.UpdateUser.
...
// DeleteUser calls mineserver.v1.UserService.DeleteUser.
...
// UserServiceHandler is an implementation of the mineserver.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/mineserver.v1.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect.Request[v1.ListUsersRequest]) (*connect.Response[v1.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[v1.UpdateUserRequest]) (*connect.Response[v1.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[v1.DeleteUserRequest]) (*connect.Response[v1.DeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("mineserver.v1.UserService.DeleteUser is not implemented"))
}
