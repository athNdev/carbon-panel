...
const (
	...
	UploadServiceName = "discopanel.v1.UploadService"
)
...
const (
	...
	// RPC.
	UploadServiceInitUploadProcedure = "/discopanel.v1.UploadService/InitUpload"
	// UploadServiceGetUploadStatusProcedure is the fully-qualified name of the UploadService's
	// GetUploadStatus RPC.
	UploadServiceGetUploadStatusProcedure = "/discopanel.v1.UploadService/GetUploadStatus"
	// UploadServiceUploadChunkProcedure is the fully-qualified name of the UploadService's UploadChunk
	// RPC.
	UploadServiceUploadChunkProcedure = "/discopanel.v1.UploadService/UploadChunk"
	// UploadServiceCancelUploadProcedure is the fully-qualified name of the UploadService's
	// CancelUpload RPC.
	UploadServiceCancelUploadProcedure = "/discopanel.v1.UploadService/CancelUpload"
)

// UploadServiceClient is a client for the discopanel.v1.UploadService service.
...
// NewUploadServiceClient constructs a client for the discopanel.v1.UploadService service. By
...
func NewUploadServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UploadServiceClient {
	...
	uploadServiceMethods := v1.File_discopanel_v1_upload_proto.Services().ByName("UploadService").Methods()
...
// InitUpload calls discopanel.v1.UploadService.InitUpload.
...
// GetUploadStatus calls discopanel.v1.UploadService.GetUploadStatus.
...
// UploadChunk calls discopanel.v1.UploadService.UploadChunk.
...
// CancelUpload calls discopanel.v1.UploadService.CancelUpload.
...
// UploadServiceHandler is an implementation of the discopanel.v1.UploadService service.
...
func NewUploadServiceHandler(svc UploadServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/discopanel.v1.UploadService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUploadServiceHandler) InitUpload(context.Context, *connect.Request[v1.InitUploadRequest]) (*connect.Response[v1.InitUploadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("discopanel.v1.UploadService.InitUpload is not implemented"))
}
...
func (UnimplementedUploadServiceHandler) GetUploadStatus(context.Context, *connect.Request[v1.GetUploadStatusRequest]) (*connect.Response[v1.GetUploadStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("discopanel.v1.UploadService.GetUploadStatus is not implemented"))
}
...
func (UnimplementedUploadServiceHandler) UploadChunk(context.Context, *connect.Request[v1.UploadChunkRequest]) (*connect.Response[v1.UploadChunkResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("discopanel.v1.UploadService.UploadChunk is not implemented"))
}
...
func (UnimplementedUploadServiceHandler) CancelUpload(context.Context, *connect.Request[v1.CancelUploadRequest]) (*connect.Response[v1.CancelUploadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("discopanel.v1.UploadService.CancelUpload is not implemented"))
}
