...
const (
	...
	ConfigServiceName = "discopanel.v1.ConfigService"
)
...
const (
	...
	// GetServerConfig RPC.
	ConfigServiceGetServerConfigProcedure = "/discopanel.v1.ConfigService/GetServerConfig"
	// ConfigServiceUpdateServerConfigProcedure is the fully-qualified name of the ConfigService's
	// UpdateServerConfig RPC.
	ConfigServiceUpdateServerConfigProcedure = "/discopanel.v1.ConfigService/UpdateServerConfig"
	// ConfigServiceGetGlobalSettingsProcedure is the fully-qualified name of the ConfigService's
	// GetGlobalSettings RPC.
	ConfigServiceGetGlobalSettingsProcedure = "/discopanel.v1.ConfigService/GetGlobalSettings"
...
func NewConfigServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ConfigServiceClient {
	...
	configServiceMethods := v1.File_discopanel_v1_config_proto.Services().ByName("ConfigService").Methods()
...
// UpdateServerConfig calls discopanel.v1.ConfigService.UpdateServerConfig.
...
// GetGlobalSettings calls discopanel.v1.ConfigService.GetGlobalSettings.
...
// UpdateGlobalSettings calls discopanel.v1.ConfigService.UpdateGlobalSettings.
...
func (UnimplementedConfigServiceHandler) GetServerConfig(context.Context, *connect.Request[v1.GetServerConfigRequest]) (*connect.Response[v1.GetServerConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("discopanel.v1.ConfigService.GetServerConfig is not implemented"))
}
...
func (UnimplementedConfigServiceHandler) UpdateServerConfig(context.Context, *connect.Request[v1.UpdateServerConfigRequest]) (*connect.Response[v1.UpdateServerConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("discopanel.v1.ConfigService.UpdateServerConfig is not implemented"))
}
...
func (UnimplementedConfigServiceHandler) GetGlobalSettings(context.Context, *connect.Request[v1.GetGlobalSettingsRequest]) (*connect.Response[v1.GetGlobalSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("discopanel.v1.ConfigService.GetGlobalSettings is not implemented"))
}
