...
const (
	...
	FileServiceName = "carbonpanel.v1.FileService"
)
...
const (
	...
	FileServiceGetRemoteArchiveProgressProcedure = "/carbonpanel.v1.FileService/GetRemoteArchiveProgress"
)

// FileServiceClient is a client for the carbonpanel.v1.FileService service.
...
// NewFileServiceClient constructs a client for the carbonpanel.v1.FileService service. By default,
...
func NewFileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FileServiceClient {
	...
	fileServiceMethods := v1.File_carbonpanel_v1_file_proto.Services().ByName("FileService").Methods()
...
// ListFiles calls carbonpanel.v1.FileService.ListFiles.
...
// GetFile calls carbonpanel.v1.FileService.GetFile.
...
// SaveUploadedFile calls carbonpanel.v1.FileService.SaveUploadedFile.
...
// UpdateFile calls carbonpanel.v1.FileService.UpdateFile.
...
// DeleteFile calls carbonpanel.v1.FileService.DeleteFile.
...
// RenameFile calls carbonpanel.v1.FileService.RenameFile.
...
// ExtractArchive calls carbonpanel.v1.FileService.ExtractArchive.
...
// CreateFolder calls carbonpanel.v1.FileService.CreateFolder.
...
// MoveFile calls carbonpanel.v1.FileService.MoveFile.
...
// CopyFile calls carbonpanel.v1.FileService.CopyFile.
...
// CreateArchive calls carbonpanel.v1.FileService.CreateArchive.
...
// DownloadArchive calls carbonpanel.v1.FileService.DownloadArchive.
...
// InitFileDownload calls carbonpanel.v1.FileService.InitFileDownload.
...
// GetExtractionStatus calls carbonpanel.v1.FileService.GetExtractionStatus.
...
// DownloadRemoteArchive calls carbonpanel.v1.FileService.DownloadRemoteArchive.
...
// GetRemoteArchiveProgress calls carbonpanel.v1.FileService.GetRemoteArchiveProgress.
...
// FileServiceHandler is an implementation of the carbonpanel.v1.FileService service.
...
func NewFileServiceHandler(svc FileServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/carbonpanel.v1.FileService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedFileServiceHandler) ListFiles(context.Context, *connect.Request[v1.ListFilesRequest]) (*connect.Response[v1.ListFilesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.ListFiles is not implemented"))
}
...
func (UnimplementedFileServiceHandler) GetFile(context.Context, *connect.Request[v1.GetFileRequest]) (*connect.Response[v1.GetFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.GetFile is not implemented"))
}
...
func (UnimplementedFileServiceHandler) SaveUploadedFile(context.Context, *connect.Request[v1.SaveUploadedFileRequest]) (*connect.Response[v1.SaveUploadedFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.SaveUploadedFile is not implemented"))
}
...
func (UnimplementedFileServiceHandler) UpdateFile(context.Context, *connect.Request[v1.UpdateFileRequest]) (*connect.Response[v1.UpdateFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.UpdateFile is not implemented"))
}
...
func (UnimplementedFileServiceHandler) DeleteFile(context.Context, *connect.Request[v1.DeleteFileRequest]) (*connect.Response[v1.DeleteFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.DeleteFile is not implemented"))
}
...
func (UnimplementedFileServiceHandler) RenameFile(context.Context, *connect.Request[v1.RenameFileRequest]) (*connect.Response[v1.RenameFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.RenameFile is not implemented"))
}
...
func (UnimplementedFileServiceHandler) ExtractArchive(context.Context, *connect.Request[v1.ExtractArchiveRequest]) (*connect.Response[v1.ExtractArchiveResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.ExtractArchive is not implemented"))
}
...
func (UnimplementedFileServiceHandler) CreateFolder(context.Context, *connect.Request[v1.CreateFolderRequest]) (*connect.Response[v1.CreateFolderResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.CreateFolder is not implemented"))
}
...
func (UnimplementedFileServiceHandler) MoveFile(context.Context, *connect.Request[v1.MoveFileRequest]) (*connect.Response[v1.MoveFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.MoveFile is not implemented"))
}
...
func (UnimplementedFileServiceHandler) CopyFile(context.Context, *connect.Request[v1.CopyFileRequest]) (*connect.Response[v1.CopyFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.CopyFile is not implemented"))
}
...
func (UnimplementedFileServiceHandler) CreateArchive(context.Context, *connect.Request[v1.CreateArchiveRequest]) (*connect.Response[v1.CreateArchiveResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.CreateArchive is not implemented"))
}
...
func (UnimplementedFileServiceHandler) DownloadArchive(context.Context, *connect.Request[v1.DownloadArchiveRequest]) (*connect.Response[v1.DownloadArchiveResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.DownloadArchive is not implemented"))
}
...
func (UnimplementedFileServiceHandler) InitFileDownload(context.Context, *connect.Request[v1.InitFileDownloadRequest]) (*connect.Response[v1.InitFileDownloadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.InitFileDownload is not implemented"))
}
...
func (UnimplementedFileServiceHandler) GetExtractionStatus(context.Context, *connect.Request[v1.GetExtractionStatusRequest]) (*connect.Response[v1.GetExtractionStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.GetExtractionStatus is not implemented"))
}
...
func (UnimplementedFileServiceHandler) DownloadRemoteArchive(context.Context, *connect.Request[v1.DownloadRemoteArchiveRequest]) (*connect.Response[v1.DownloadRemoteArchiveResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.DownloadRemoteArchive is not implemented"))
}
...
func (UnimplementedFileServiceHandler) GetRemoteArchiveProgress(context.Context, *connect.Request[v1.GetRemoteArchiveProgressRequest]) (*connect.Response[v1.GetRemoteArchiveProgressResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("carbonpanel.v1.FileService.GetRemoteArchiveProgress is not implemented"))
}
