...
const (
	...
	AuditServiceName = "cloud.v1.AuditService"
)
...
const (
	...
	// ListAuditEvents RPC.
	AuditServiceListAuditEventsProcedure = "/cloud.v1.AuditService/ListAuditEvents"
	// AuditServiceGetAuditEventProcedure is the fully-qualified name of the AuditService's
	// GetAuditEvent RPC.
	AuditServiceGetAuditEventProcedure = "/cloud.v1.AuditService/GetAuditEvent"
)

// AuditServiceClient is a client for the cloud.v1.AuditService service.
...
// NewAuditServiceClient constructs a client for the cloud.v1.AuditService service. By default, it
...
func NewAuditServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuditServiceClient {
	...
	auditServiceMethods := v1.File_cloud_v1_audit_proto.Services().ByName("AuditService").Methods()
...
// ListAuditEvents calls cloud.v1.AuditService.ListAuditEvents.
...
// GetAuditEvent calls cloud.v1.AuditService.GetAuditEvent.
...
// AuditServiceHandler is an implementation of the cloud.v1.AuditService service.
...
func NewAuditServiceHandler(svc AuditServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/cloud.v1.AuditService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuditServiceHandler) ListAuditEvents(context.Context, *connect.Request[v1.ListAuditEventsRequest]) (*connect.Response[v1.ListAuditEventsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("cloud.v1.AuditService.ListAuditEvents is not implemented"))
}
...
func (UnimplementedAuditServiceHandler) GetAuditEvent(context.Context, *connect.Request[v1.GetAuditEventRequest]) (*connect.Response[v1.GetAuditEventResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("cloud.v1.AuditService.GetAuditEvent is not implemented"))
}
