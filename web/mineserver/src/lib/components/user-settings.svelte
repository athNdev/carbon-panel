<script lang="ts">
	...
	import type { User, Role } from '$lib/proto/mineserver/v1/common_pb';
	import type { RegistrationInvite } from '$lib/proto/mineserver/v1/auth_pb';
	import {
		CreateUserRequestSchema,
		UpdateUserRequestSchema,
		DeleteUserRequestSchema
	} from '$lib/proto/mineserver/v1/user_pb';
	import {
		CreateInviteRequestSchema,
		DeleteInviteRequestSchema
	} from '$lib/proto/mineserver/v1/auth_pb';
