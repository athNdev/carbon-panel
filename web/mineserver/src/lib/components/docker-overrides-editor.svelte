<script lang="ts">
	...
	import type { DockerOverrides, VolumeMount } from '$lib/proto/mineserver/v1/common_pb';
	import { DockerOverridesSchema, VolumeMountSchema } from '$lib/proto/mineserver/v1/common_pb';
	...
	function updateLabel(oldKey: string, newKey: string, value: string) {
		...
		if (newKey.startsWith('mineserver.') && oldKey !== newKey) {
