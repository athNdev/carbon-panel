<script lang="ts">
	...
	import type { Role, Permission } from '$lib/proto/mineserver/v1/common_pb';
	import type { ScopeableObject, ResourceActions } from '$lib/proto/mineserver/v1/role_pb';
	import {
		CreateRoleRequestSchema,
		DeleteRoleRequestSchema,
		GetPermissionMatrixRequestSchema,
		UpdatePermissionsRequestSchema
	} from '$lib/proto/mineserver/v1/role_pb';
