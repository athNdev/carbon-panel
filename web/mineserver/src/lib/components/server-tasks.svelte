<script lang="ts">
	...
	import type { ScheduledTask, TaskExecution } from '$lib/proto/mineserver/v1/task_pb';
	import {
		TaskType,
		TaskStatus,
		ScheduleType,
	...
	} from '$lib/proto/mineserver/v1/task_pb';
	import { TriggeredEventType } from '$lib/proto/mineserver/v1/event_pb';
  ...
  "blocks": [
    ...
    {
      "type": "context",
      "elements": [{"type": "mrkdwn", "text": "MineServer â€¢ {{.timestamp}}"}]
    }
  ]
}`,
		teams: `{
