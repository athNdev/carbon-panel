<script lang="ts">
	...
	import type { UpdateServerRequest } from '$lib/proto/mineserver/v1/server_pb';
	import { UpdateServerRequestSchema, MigrateServerRequestSchema } from '$lib/proto/mineserver/v1/server_pb';
	...
	} from '$lib/proto/mineserver/v1/minecraft_pb';
	import {
