...
// SERVICES
import { AuthService } from '$lib/proto/mineserver/v1/auth_pb';
import { ConfigService } from '$lib/proto/mineserver/v1/config_pb';
import { FileService } from '$lib/proto/mineserver/v1/file_pb';
import { MinecraftService } from '$lib/proto/mineserver/v1/minecraft_pb';
import { ModService } from '$lib/proto/mineserver/v1/mod_pb';
import { ModpackService } from '$lib/proto/mineserver/v1/modpack_pb';
import { ProxyService } from '$lib/proto/mineserver/v1/proxy_pb';
import { ServerService } from '$lib/proto/mineserver/v1/server_pb';
import { SupportService } from '$lib/proto/mineserver/v1/support_pb';
import { TaskService } from '$lib/proto/mineserver/v1/task_pb';
import { UploadService } from '$lib/proto/mineserver/v1/upload_pb';
import { UserService } from '$lib/proto/mineserver/v1/user_pb';
import { RoleService } from '$lib/proto/mineserver/v1/role_pb';
import { ModuleService } from '$lib/proto/mineserver/v1/module_pb';
import { NodeService } from '$lib/proto/mineserver/v1/node_pb';
...
export class RpcClient {
	...
	constructor() {
		...
		this.node = createClient(NodeService, transport);
	}
}
