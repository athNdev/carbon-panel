...
import { ModpackService } from '$lib/proto/carbonpanel/v1/modpack_pb';
import { ProxyService } from '$lib/proto/carbonpanel/v1/proxy_pb';
import { ServerService } from '$lib/proto/carbonpanel/v1/server_pb';
import { SupportService } from '$lib/proto/carbonpanel/v1/support_pb';
import { TaskService } from '$lib/proto/carbonpanel/v1/task_pb';
import { UploadService } from '$lib/proto/carbonpanel/v1/upload_pb';
import { UserService } from '$lib/proto/carbonpanel/v1/user_pb';
import { RoleService } from '$lib/proto/carbonpanel/v1/role_pb';
import { ModuleService } from '$lib/proto/carbonpanel/v1/module_pb';
import { NodeService } from '$lib/proto/carbonpanel/v1/node_pb';
...
export class RpcClient {
	...
	public readonly backup: Client<typeof BackupService>;
	...
	constructor() {
		...
		this.backup = createClient(BackupService, transport);
