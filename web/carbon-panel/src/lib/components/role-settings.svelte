<script lang="ts">
	...
	import type { Role, Permission } from '$lib/proto/carbonpanel/v1/common_pb';
	import type { ScopeableObject, ResourceActions } from '$lib/proto/carbonpanel/v1/role_pb';
	import {
		CreateRoleRequestSchema,
		DeleteRoleRequestSchema,
		GetPermissionMatrixRequestSchema,
		UpdatePermissionsRequestSchema
	} from '$lib/proto/carbonpanel/v1/role_pb';
	...
	// Map resource â†’ scope source (e.g., "files" â†’ "servers")
