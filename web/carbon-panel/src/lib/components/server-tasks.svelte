<script lang="ts">
	...
	import type { ScheduledTask, TaskExecution } from '$lib/proto/carbonpanel/v1/task_pb';
	import {
		TaskType,
		TaskStatus,
		ScheduleType,
	...
	} from '$lib/proto/carbonpanel/v1/task_pb';
	import { TriggeredEventType } from '$lib/proto/carbonpanel/v1/event_pb';
