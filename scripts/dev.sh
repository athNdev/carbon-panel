#!/bin/bash
# ==============================================================================
# MineServer Local Development Server Launcher (Bash)
...
echo -e "\033[36m=================================================="
echo -e "   MineServer Live Development Environment"
echo -e "=================================================="
...
if ! command -v air &> /dev/null; then
    ...
    if [ -f "$GOPATH/bin/air" ]; then
        ...
        echo -e "\033[33mFalling back to 'go run cmd/mineserver/main.go'...\033[0m"
        AIR_CMD="go run cmd/mineserver/main.go"
    fi
fi
