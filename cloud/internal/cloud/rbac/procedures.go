...
var procedurePermissions = map[string]Permission{
	...
	cloudv1connect.WorkloadServiceCreateWorkloadBackupProcedure:     PermWorkloadsWrite,
	cloudv1connect.WorkloadServiceListWorkloadBackupsProcedure:      PermWorkloadsRead,
	cloudv1connect.WorkloadServiceRestoreWorkloadBackupProcedure:    PermWorkloadsWrite,
	...
	cloudv1connect.WorkloadServiceHibernateWorkloadProcedure:        PermWorkloadsWrite,
	cloudv1connect.WorkloadServiceWakeWorkloadProcedure:             PermWorkloadsWrite,
	cloudv1connect.WorkloadServiceSyncIngressRoutesProcedure:        PermWorkloadsWrite,
	// FileService.
...
func AllProcedures() []string {
	return []string{
		...
		cloudv1connect.WorkloadServiceCreateWorkloadBackupProcedure,
		cloudv1connect.WorkloadServiceListWorkloadBackupsProcedure,
		cloudv1connect.WorkloadServiceRestoreWorkloadBackupProcedure,
		...
		cloudv1connect.WorkloadServiceHibernateWorkloadProcedure,
		cloudv1connect.WorkloadServiceWakeWorkloadProcedure,
		cloudv1connect.WorkloadServiceSyncIngressRoutesProcedure,
